---
title: "Goals (ClawKitchen)"
description: "ClawKitchen stores goals as **markdown files** in the OpenClaw **global workspace**."
---

<!-- GENERATED FILE: do not edit directly -->
<!-- Source: JIGGAI/ClawKitchen/docs/GOALS.md @ 5c59023 -->
