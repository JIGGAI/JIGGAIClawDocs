...
description: "ClawKitchen provides integrated media generation capabilities through workflow nodes that can create images, videos, and audio content. This system uses skill auto-discovery to"
generated: true
