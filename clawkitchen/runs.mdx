---
title: "Runs"
description: "How to use ClawKitchen to inspect workflow runs across teams, debug outcomes, and follow approvals."
---
...
![ClawKitchen runs page](/images/clawkitchen/runs.png)
