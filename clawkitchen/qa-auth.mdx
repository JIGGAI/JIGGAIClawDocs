---
title: "ClawKitchen QA Auth (headless-friendly)"
description: "ClawKitchen can optionally be protected by HTTP Basic auth when binding to a non-localhost host (e.g. Tailscale IP)."
---

<!-- GENERATED FILE: do not edit directly -->
<!-- Source: JIGGAI/ClawKitchen/docs/QA_AUTH.md @ 5c59023 -->
