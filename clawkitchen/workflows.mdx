---
title: "Workflows"
description: "ClawKitchen's workflow system provides a complete visual interface for creating, managing, and operating automation workflows. Built on the file-first ClawRecipes foundation, it co"
generated: true
...
- **[Workflow Visual Editor](workflow-visual-editor)**: Complete guide to the visual editor
- **[Media Generation](media-generation)**: AI-powered content creation workflows
- **[Team Memory](team-memory)**: Knowledge management and workflow context
