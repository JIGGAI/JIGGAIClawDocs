...
description: "This project uses a **file-first** memory model with clear boundaries so we get: - continuity where it’s safe (assistant-local) - shared coordination where it’s needed (team"
generated: true
