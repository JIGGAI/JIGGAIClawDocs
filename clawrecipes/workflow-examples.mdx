...
description: "This document gives you copyable workflow patterns for ClawRecipes."
generated: true
...
- [WORKFLOW_RUNS_FILE_FIRST.md](workflow-runs-file-first) — concepts, node kinds, triggers, runs, edges
- [OUTBOUND_POSTING.md](outbound-posting) — publishing/posting setup
...
1. [WORKFLOW_RUNS_FILE_FIRST.md](workflow-runs-file-first)
2. this file
3. [OUTBOUND_POSTING.md](outbound-posting)
