...
- [WORKFLOW_NODES.md](workflow-nodes) — runtime node config reference (LLM/media/tool/approval)
...
For full posting details, see [OUTBOUND_POSTING.md](outbound-posting).
...
See: [OUTBOUND_POSTING.md](outbound-posting)
