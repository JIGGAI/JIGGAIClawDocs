...
slug: "/clawrecipes/workflow-runs-file-first"
---

If you want a copy-paste cookbook after reading this reference, also see:
- [Workflow examples](/clawrecipes/workflow-examples)
...
For full posting details, see [Outbound posting](/clawrecipes/outbound-posting).
