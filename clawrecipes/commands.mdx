...
More:
- [WORKFLOW_RUNS_FILE_FIRST.md](/clawrecipes/workflow-runs-file-first) — node kinds, triggers, runs, edges, runner/worker model, approvals
- [WORKFLOW_EXAMPLES.md](/clawrecipes/workflow-examples) — copy-paste workflow patterns
- [OUTBOUND_POSTING.md](/clawrecipes/outbound-posting) — publishing/posting behavior and setup
