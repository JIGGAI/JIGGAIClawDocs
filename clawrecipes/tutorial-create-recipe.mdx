...
If that fails, go back to [INSTALLATION.md](/clawrecipes/installation).
...
Read these next:
- [RECIPE_FORMAT.md](/clawrecipes/recipe-format)
- [TEAM_WORKFLOW.md](/clawrecipes/team-workflow)
- [WORKFLOW_RUNS_FILE_FIRST.md](/clawrecipes/workflow-runs-file-first)
